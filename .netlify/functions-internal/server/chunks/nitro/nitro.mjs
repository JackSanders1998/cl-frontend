...
import { isPlainObject as isPlainObject$1, isRedirect as isRedirect$1, isNotFound, createMemoryHistory, RouterProvider, warning, createControlledPromise, pick, TSR_DEFERRED_PROMISE, isPlainArray, defer as defer$1, createRootRoute, Outlet, createFileRoute, lazyRouteComponent, lazyFn, ErrorComponent, Link, useRouter, useMatch, rootRouteId, useLocation, useRouterState, createRouter as createRouter$2, encode as encode$1 } from '@tanstack/react-router';
import L from 'tiny-invariant';
import { AsyncLocalStorage } from 'node:async_hooks';
import { createClerkHandler } from '@clerk/tanstack-start/server';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { ClerkProvider, SignIn, SignedIn, UserButton, SignedOut, SignInButton } from '@clerk/tanstack-start';
import { TanStackRouterDevtools } from '@tanstack/router-devtools';
import * as v from '@headlessui/react';
import f$2 from 'clsx';
import * as nt from 'react';
import { forwardRef, createElement, useState, useId } from 'react';
import { motion, LayoutGroup } from 'framer-motion';
import { ChevronUpIcon, UserCircleIcon, ShieldCheckIcon, LightBulbIcon, ArrowRightStartOnRectangleIcon } from '@heroicons/react/16/solid';
import { HomeIcon, Square2StackIcon, TicketIcon, Cog6ToothIcon } from '@heroicons/react/20/solid';
import I$1 from 'jsesc';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/jack/dev/cl-frontend","order":0,"outDir":"/Users/jack/dev/cl-frontend/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/jack/dev/cl-frontend","outDir":"/Users/jack/dev/cl-frontend/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/jack/dev/cl-frontend","base":"/","outDir":"/Users/jack/dev/cl-frontend/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/jack/dev/cl-frontend","outDir":"/Users/jack/dev/cl-frontend/.vinxi/build/server","order":3}],"server":{"preset":"netlify","experimental":{"asyncContext":true}},"root":"/Users/jack/dev/cl-frontend"};
				const buildManifest = {"client":{"/Users/jack/dev/cl-frontend/app/styles/app.css":{"file":"assets/app-CBNuGcbA.css","src":"/Users/jack/dev/cl-frontend/app/styles/app.css"},"_client-m4m4Z0YJ.js":{"file":"assets/client-m4m4Z0YJ.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/_authed/seshes/index.tsx?tsr-split","app/routes/_authed/seshes/index.tsx?tsr-split","app/routes/_authed/locations/index.tsx?tsr-split","app/routes/_authed/locations/index.tsx?tsr-split","app/routes/_authed/climbs/index.tsx?tsr-split","app/routes/_authed/climbs/index.tsx?tsr-split","app/routes/_authed/seshes/$seshId.tsx?tsr-split","app/routes/_authed/seshes/$seshId.tsx?tsr-split","app/routes/_authed/profile.$.tsx?tsr-split","app/routes/_authed/profile.$.tsx?tsr-split","app/routes/_authed/locations/$locationId.tsx?tsr-split","app/routes/_authed/locations/$locationId.tsx?tsr-split","app/routes/_authed/climbs/$climbId.tsx?tsr-split","app/routes/_authed/climbs/$climbId.tsx?tsr-split"],"assets":["assets/app-CBNuGcbA.css"]},"_climbs-BruOxBXE.js":{"file":"assets/climbs-BruOxBXE.js","name":"climbs","imports":["_client-m4m4Z0YJ.js"]},"_heading-D1ELUsS5.js":{"file":"assets/heading-D1ELUsS5.js","name":"heading","imports":["_client-m4m4Z0YJ.js"]},"_locations-BODcd5HN.js":{"file":"assets/locations-BODcd5HN.js","name":"locations","imports":["_client-m4m4Z0YJ.js"]},"app/routes/_authed/climbs/$climbId.tsx?tsr-split":{"file":"assets/_climbId-CHyp2nAM.js","name":"_climbId","src":"app/routes/_authed/climbs/$climbId.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_climbs-BruOxBXE.js"]},"app/routes/_authed/climbs/index.tsx?tsr-split":{"file":"assets/index-BxZzDeUe.js","name":"index","src":"app/routes/_authed/climbs/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_climbs-BruOxBXE.js"]},"app/routes/_authed/locations/$locationId.tsx?tsr-split":{"file":"assets/_locationId-D24aIqAq.js","name":"_locationId","src":"app/routes/_authed/locations/$locationId.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_locations-BODcd5HN.js"]},"app/routes/_authed/locations/index.tsx?tsr-split":{"file":"assets/index-CWy93uiW.js","name":"index","src":"app/routes/_authed/locations/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_locations-BODcd5HN.js"]},"app/routes/_authed/profile.$.tsx?tsr-split":{"file":"assets/profile._-D3SVnMWS.js","name":"profile._","src":"app/routes/_authed/profile.$.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_locations-BODcd5HN.js"]},"app/routes/_authed/seshes/$seshId.tsx?tsr-split":{"file":"assets/_seshId-BmXFuOA2.js","name":"_seshId","src":"app/routes/_authed/seshes/$seshId.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_heading-D1ELUsS5.js"]},"app/routes/_authed/seshes/index.tsx?tsr-split":{"file":"assets/index-LV8xGfBg.js","name":"index","src":"app/routes/_authed/seshes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js","_heading-D1ELUsS5.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-DLookipS.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-m4m4Z0YJ.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-zLRlkAJC.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-m4m4Z0YJ.js"]}},"ssr":{"/Users/jack/dev/cl-frontend/app/styles/app.css":{"file":"assets/app-D1RL4WOa.css","src":"/Users/jack/dev/cl-frontend/app/styles/app.css"},"_climbs-ZLTKmgZy.js":{"file":"assets/climbs-ZLTKmgZy.js","name":"climbs","imports":["_ssr-D-5xtsK4.js"]},"_heading-B68eS6V4.js":{"file":"assets/heading-B68eS6V4.js","name":"heading","imports":["_ssr-D-5xtsK4.js"]},"_locations-1lLG7ji0.js":{"file":"assets/locations-1lLG7ji0.js","name":"locations","imports":["_ssr-D-5xtsK4.js"]},"_ssr-D-5xtsK4.js":{"file":"assets/ssr-D-5xtsK4.js","name":"ssr","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/_authed/seshes/index.tsx?tsr-split","app/routes/_authed/seshes/index.tsx?tsr-split","app/routes/_authed/locations/index.tsx?tsr-split","app/routes/_authed/locations/index.tsx?tsr-split","app/routes/_authed/climbs/index.tsx?tsr-split","app/routes/_authed/climbs/index.tsx?tsr-split","app/routes/_authed/seshes/$seshId.tsx?tsr-split","app/routes/_authed/seshes/$seshId.tsx?tsr-split","app/routes/_authed/profile.$.tsx?tsr-split","app/routes/_authed/profile.$.tsx?tsr-split","app/routes/_authed/locations/$locationId.tsx?tsr-split","app/routes/_authed/locations/$locationId.tsx?tsr-split","app/routes/_authed/climbs/$climbId.tsx?tsr-split","app/routes/_authed/climbs/$climbId.tsx?tsr-split"],"assets":["assets/app-D1RL4WOa.css"]},"app/routes/_authed/climbs/$climbId.tsx?tsr-split":{"file":"assets/_climbId-BfcgRlJO.js","name":"_climbId","src":"app/routes/_authed/climbs/$climbId.tsx?tsr-split","isDynamicEntry":true,"imports":["_climbs-ZLTKmgZy.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/climbs/index.tsx?tsr-split":{"file":"assets/index-BeldkAS-.js","name":"index","src":"app/routes/_authed/climbs/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_climbs-ZLTKmgZy.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/locations/$locationId.tsx?tsr-split":{"file":"assets/_locationId-CxiU5eSb.js","name":"_locationId","src":"app/routes/_authed/locations/$locationId.tsx?tsr-split","isDynamicEntry":true,"imports":["_locations-1lLG7ji0.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/locations/index.tsx?tsr-split":{"file":"assets/index-DQ5uKE0Y.js","name":"index","src":"app/routes/_authed/locations/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_locations-1lLG7ji0.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/profile.$.tsx?tsr-split":{"file":"assets/profile._-CqEadVfS.js","name":"profile._","src":"app/routes/_authed/profile.$.tsx?tsr-split","isDynamicEntry":true,"imports":["_locations-1lLG7ji0.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/seshes/$seshId.tsx?tsr-split":{"file":"assets/_seshId-4aVW5buw.js","name":"_seshId","src":"app/routes/_authed/seshes/$seshId.tsx?tsr-split","isDynamicEntry":true,"imports":["_heading-B68eS6V4.js","_ssr-D-5xtsK4.js"]},"app/routes/_authed/seshes/index.tsx?tsr-split":{"file":"assets/index-CBPJuYSz.js","name":"index","src":"app/routes/_authed/seshes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_heading-B68eS6V4.js","_ssr-D-5xtsK4.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-DO81Sifg.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-D-5xtsK4.js"]}},"server":{"_constants-Bt2f24c3.js":{"file":"assets/constants-Bt2f24c3.js","name":"constants"},"_index-DiV1A1mM.js":{"file":"assets/index-DiV1A1mM.js","name":"index","imports":["_server-G5kUeQ40.js"]},"_server-G5kUeQ40.js":{"file":"assets/server-G5kUeQ40.js","name":"server","dynamicImports":["app/routes/__root.tsx?tsr-directive-use-server=","app/utils/seshes.ts?tsr-directive-use-server=","app/utils/seshes.ts?tsr-directive-use-server=","app/utils/locations.ts?tsr-directive-use-server=","app/utils/locations.ts?tsr-directive-use-server=","app/utils/climbs.ts?tsr-directive-use-server=","app/utils/climbs.ts?tsr-directive-use-server="]},"app/routes/__root.tsx?tsr-directive-use-server=":{"file":"assets/__root-CRAk0HXI.js","name":"__root","src":"app/routes/__root.tsx?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_index-DiV1A1mM.js","_server-G5kUeQ40.js"]},"app/utils/climbs.ts?tsr-directive-use-server=":{"file":"assets/climbs-D_EJdI4J.js","name":"climbs","src":"app/utils/climbs.ts?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_constants-Bt2f24c3.js","_index-DiV1A1mM.js","_server-G5kUeQ40.js"]},"app/utils/locations.ts?tsr-directive-use-server=":{"file":"assets/locations-C-S5g8cW.js","name":"locations","src":"app/utils/locations.ts?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_constants-Bt2f24c3.js","_index-DiV1A1mM.js","_server-G5kUeQ40.js"]},"app/utils/seshes.ts?tsr-directive-use-server=":{"file":"assets/seshes-DryY9-lu.js","name":"seshes","src":"app/utils/seshes.ts?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_constants-Bt2f24c3.js","_index-DiV1A1mM.js","_server-G5kUeQ40.js"]},"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true,"imports":["_server-G5kUeQ40.js"]}}};
...
const f = { stringify: (e) => JSON.stringify(e, function(r, n) {
  const o = this[r], c = h.find((a) => a.stringifyCondition(o));
  return c ? c.stringify(o) : n;
}), parse: (e) => JSON.parse(e, function(r, n) {
  const o = this[r];
  if (isPlainObject$1(o)) {
    const c = h.find((a) => a.parseCondition(o));
    if (c) return c.parse(o);
  }
  return n;
}), encode: (e) => {
  if (Array.isArray(e)) return e.map((r) => f.encode(r));
  if (isPlainObject$1(e)) return Object.fromEntries(Object.entries(e).map(([r, n]) => [r, f.encode(n)]));
  ...
  return Array.isArray(e) ? e.map((t) => f.decode(t)) : isPlainObject$1(e) ? Object.fromEntries(Object.entries(e).map(([t, r]) => [t, f.decode(r)])) : e;
} }, d = (e, t, r, n) => ({ key: e, stringifyCondition: t, stringify: (o) => ({ [`$${e}`]: r(o) }), parseCondition: (o) => Object.hasOwn(o, `$${e}`), parse: (o) => n(o[`$${e}`]) }), h = [d("undefined", (e) => e === void 0, () => 0, () => {
...
function P(e) {
  let t;
  const r = x(e), n = { duplex: "half", method: e.method, headers: e.headers };
...
function R(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: P(e), url: x(e) }, e.web.request;
}
function W$1() {
  return T$1();
}
const E = Symbol("$HTTPEvent");
function I(e) {
  return typeof e == "object" && (e instanceof H3Event || (e == null ? void 0 : e[E]) instanceof H3Event || (e == null ? void 0 : e.__is_event__) === true);
}
function p(e) {
  return function(...t) {
    var r;
    let n = t[0];
    if (I(n)) t[0] = n instanceof H3Event || n.__is_event__ ? n : n[E];
    else {
      ...
      if (n = W$1(), !n) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      t.unshift(n);
    }
    return e(...t);
  };
}
const x = p(getRequestURL), J = p(getResponseStatus), U = p(getHeaders), B$1 = p(getRequestWebStream), re$1 = p(R);
function V() {
  var e;
...
const G = { "app_routes_root_tsx--fetchClerkAuth_createServerFn_handler": { functionName: "fetchClerkAuth_createServerFn_handler", importer: () => import('../build/__root-CRAk0HXI.mjs') }, "app_utils_seshes_ts--fetchSesh_createServerFn_handler": { functionName: "fetchSesh_createServerFn_handler", importer: () => import('../build/seshes-DryY9-lu.mjs') }, "app_utils_seshes_ts--fetchSeshes_createServerFn_handler": { functionName: "fetchSeshes_createServerFn_handler", importer: () => import('../build/seshes-DryY9-lu.mjs') }, "app_utils_locations_ts--fetchLocation_createServerFn_handler": { functionName: "fetchLocation_createServerFn_handler", importer: () => import('../build/locations-C-S5g8cW.mjs') }, "app_utils_locations_ts--fetchLocations_createServerFn_handler": { functionName: "fetchLocations_createServerFn_handler", importer: () => import('../build/locations-C-S5g8cW.mjs') }, "app_utils_climbs_ts--fetchClimb_createServerFn_handler": { functionName: "fetchClimb_createServerFn_handler", importer: () => import('../build/climbs-D_EJdI4J.mjs') }, "app_utils_climbs_ts--fetchClimbs_createServerFn_handler": { functionName: "fetchClimbs_createServerFn_handler", importer: () => import('../build/climbs-D_EJdI4J.mjs') } }, ne = eventHandler(K$1), m = G;
async function K$1(e) {
  const t = R(e), r = await X$1(t);
  return Object.entries(U()).forEach(([n, o]) => {
...
async function X$1(e, t) {
  ...
  const _ = m[a];
  if (!_) throw console.log("serverFnManifest", m), new Error("Server function info not found for " + a);
  let l;
  if (l = await _.importer(), !l) throw console.log("serverFnManifest", m), new Error("Server function module not resolved for " + a);
  const w = l[_.functionName];
  if (!w) throw console.log("serverFnManifest", m), console.log("fnModule", l), new Error(`Server function module export not resolved for serverFn ID: ${a}`);
  const A = ["multipart/form-data", "application/x-www-form-urlencoded"], g = await (async () => {
    try {
      const s = await (async () => {
        if (e.headers.get("Content-Type") && A.some((N) => {
          var v;
          return (v = e.headers.get("Content-Type")) == null ? void 0 : v.includes(N);
        })) return L(r.toLowerCase() !== "get", "GET requests with FormData payloads are not supported"), await e.formData();
        if (r.toLowerCase() === "get") return S.payload ? f.parse(S.payload) : void 0;
        const O = await e.text();
        return f.parse(O);
      })(), i = await w(s);
      return i instanceof Response ? i : isPlainObject$1(i) && "result" in i && i.result instanceof Response ? i.result : isRedirect$1(i) || isNotFound(i) ? F$1(i) : new Response(i !== void 0 ? f.stringify(i) : void 0, { status: J(T$1()), headers: { "Content-Type": "application/json" } });
    } catch (s) {
      return s instanceof Response ? s : isPlainObject$1(s) && "result" in s && s.result instanceof Response ? s.result : isRedirect$1(s) || isNotFound(s) ? F$1(s) : (console.error("Server Fn Error!"), console.error(s), console.info(), new Response(f.stringify(s), { status: 500, headers: { "Content-Type": "application/json" } }));
    }
  })();
  if (g.headers.get("Content-Type") === "application/json") {
    const i = await g.clone().text();
...
function ye({ tag: e, attrs: t, children: r }) {
  switch (e) {
    case "title":
...
function W(...e) {
  return e.reduce((t, r) => {
    const a = _t(r);
    for (const [o, i] of a.entries()) t.set(o, i);
    return t;
  }, new Headers());
}
const zt = [], y = { stringify: (e) => JSON.stringify(e, function(r, a) {
  const o = this[r], i = B.find((s) => s.stringifyCondition(o));
  return i ? i.stringify(o) : a;
}), parse: (e) => JSON.parse(e, function(r, a) {
  const o = this[r];
  if (isPlainObject$1(o)) {
    const i = B.find((s) => s.parseCondition(o));
    if (i) return i.parse(o);
  }
  return a;
}), encode: (e) => {
  if (Array.isArray(e)) return e.map((r) => y.encode(r));
  if (isPlainObject$1(e)) return Object.fromEntries(Object.entries(e).map(([r, a]) => [r, y.encode(a)]));
  const t = B.find((r) => r.stringifyCondition(e));
  return t ? t.stringify(e) : e;
}, decode: (e) => {
  if (isPlainObject$1(e)) {
    const t = B.find((r) => r.parseCondition(e));
    if (t) return t.parse(e);
  }
  return Array.isArray(e) ? e.map((t) => y.decode(t)) : isPlainObject$1(e) ? Object.fromEntries(Object.entries(e).map(([t, r]) => [t, y.decode(r)])) : e;
} }, O = (e, t, r, a) => ({ key: e, stringifyCondition: t, stringify: (o) => ({ [`$${e}`]: r(o) }), parseCondition: (o) => Object.hasOwn(o, `$${e}`), parse: (o) => a(o[`$${e}`]) }), B = [O("undefined", (e) => e === void 0, () => 0, () => {
}), O("date", (e) => e instanceof Date, (e) => e.toISOString(), (e) => new Date(e)), O("error", (e) => e instanceof Error, (e) => ({ ...e, message: e.message, stack: void 0, cause: e.cause }), (e) => Object.assign(new Error(e.message), e)), O("formData", (e) => e instanceof FormData, (e) => {
  const t = {};
  return e.forEach((r, a) => {
    const o = t[a];
    o !== void 0 ? Array.isArray(o) ? o.push(r) : t[a] = [o, r] : t[a] = r;
  }), t;
}, (e) => {
  const t = new FormData();
  return Object.entries(e).forEach(([r, a]) => {
    Array.isArray(a) ? a.forEach((o) => t.append(r, o)) : t.append(r, a);
  }), t;
})];
function K(e, t) {
  const r = t || e || {};
  return typeof r.method > "u" && (r.method = "GET"), { options: r, middleware: (a) => K(void 0, Object.assign(r, { middleware: a })), validator: (a) => K(void 0, Object.assign(r, { validator: a })), handler: (...a) => {
    const [o, i] = a;
    Object.assign(r, { ...o, extractedFn: o, serverFn: i }), o.url || (console.warn(o), warning(false, "createServerFn must be called with a function that has a 'url' property. Ensure that the @tanstack/start-plugin is ordered **before** the @tanstack/server-functions-plugin."));
    const s = [...r.middleware || [], $t(r)];
    return Object.assign(async (l) => he(s, "client", { ...o, method: r.method, data: l == null ? void 0 : l.data, headers: l == null ? void 0 : l.headers, context: {} }).then((c) => {
      if (c.error) throw c.error;
      return c.result;
    }), { ...o, __executeServer: async (l) => {
      const c = l instanceof FormData ? kt(l) : l;
      return await he(s, "server", { ...o, ...c }).then((d) => ({ result: d.result, error: d.error, context: d.sendContext }));
    } });
  } };
}
function kt(e) {
  ...
  try {
    return { context: y.parse(t), data: e };
  } catch {
    return { data: e };
  }
}
function Rt(e) {
  const t = /* @__PURE__ */ new Set(), r = [], a = (o) => {
    o.forEach((i) => {
      i.options.middleware && a(i.options.middleware), t.has(i) || (t.add(i), r.push(i));
    });
  };
  return a(e), r;
}
const ue = async (e, t, r) => e({ ...t, next: async (a = {}) => {
  var _a, _b;
  return r({ ...t, ...a, context: { ...t.context, ...a.context }, sendContext: { ...t.sendContext, ...(_a = a.sendContext) != null ? _a : {} }, headers: W(t.headers, a.headers), result: a.result !== void 0 ? a.result : t.result, error: (_b = a.error) != null ? _b : t.error });
} });
function Ct(e, t) {
  if (e == null) return {};
  if ("~standard" in e) {
...
async function he(e, t, r) {
  const a = Rt([...zt, ...e]), o = async (i) => {
    const s = a.shift();
    if (!s) return i;
    s.options.validator && (t !== "client" || s.options.validateClient) && (i.data = await Ct(s.options.validator, i.data));
    const l = t === "client" ? s.options.client : s.options.server;
    return l ? ue(l, i, async (c) => {
      const h = s.options.clientAfter;
      if (t === "client" && h) {
        const d = await o(c);
        return ue(h, { ...c, ...d }, (p) => p);
      }
      return o(c).catch((d) => {
        if (isRedirect$1(d) || isNotFound(d)) return { ...c, error: d };
        throw d;
      });
    }) : o(i);
  };
...
function $t(e) {
  return { _types: void 0, options: { validator: e.validator, validateClient: e.validateClient, client: async ({ next: t, sendContext: r, ...a }) => {
    var o;
    const i = await ((o = e.extractedFn) == null ? void 0 : o.call(e, { ...a, context: r }));
    return t(i);
  }, server: async ({ next: t, ...r }) => {
    var a;
    const o = await ((a = e.serverFn) == null ? void 0 : a.call(e, r));
    return t({ ...r, result: o });
  } } };
}
const It = () => {
  const e = useRouter(), t = useRouterState({ select: (i) => i.matches.map((s) => s.meta).filter(Boolean) }), r = nt.useMemo(() => {
    const i = [], s = {};
    let l;
    return [...t].reverse().forEach((c) => {
      [...c].reverse().forEach((h) => {
        var _a;
        if (h) if (h.title) l || (l = { tag: "title", children: h.title });
        else {
          const d = (_a = h.name) != null ? _a : h.property;
          if (d) {
            if (s[d]) return;
            s[d] = true;
          }
          i.push({ tag: "meta", attrs: { ...h } });
        }
      });
    }), l && i.push(l), i.reverse(), i;
  }, [t]), a = useRouterState({ select: (i) => i.matches.map((s) => s.links).filter(Boolean).flat(1).map((s) => ({ tag: "link", attrs: { ...s } })), structuralSharing: true }), o = useRouterState({ select: (i) => {
    const s = [];
    return i.matches.map((l) => e.looseRoutesById[l.routeId]).forEach((l) => {
      var c, h, d, p;
      return (p = (d = (h = (c = e.ssr) == null ? void 0 : c.manifest) == null ? void 0 : h.routes[l.id]) == null ? void 0 : d.preloads) == null ? void 0 : p.filter(Boolean).forEach((b) => {
        s.push({ tag: "link", attrs: { rel: "modulepreload", href: b } });
      });
    }), s;
  }, structuralSharing: true });
  return Et([...r, ...o, ...a], (i) => JSON.stringify(i));
}, Tt = () => {
  const e = It();
  return jsx(Fragment, { children: e.map((t) => createElement(ye, { ...t, key: `tsr-meta-${JSON.stringify(t)}` })) });
}, Nt = () => jsx(Fragment, { children: Tt() });
function Et(e, t) {
...
const Ht = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => {
    var i;
    const s = [], l = (i = e.ssr) == null ? void 0 : i.manifest;
    return l ? (o.matches.map((c) => e.looseRoutesById[c.routeId]).forEach((c) => {
      var h, d;
      return (d = (h = l.routes[c.id]) == null ? void 0 : h.assets) == null ? void 0 : d.filter((p) => p.tag === "script").forEach((p) => {
        s.push({ tag: "script", attrs: p.attrs, children: p.children });
      });
    }), s) : (warning(false, "<Scripts /> found no manifest"), []);
  }, structuralSharing: true }), { scripts: r } = useRouterState({ select: (o) => ({ scripts: o.matches.map((i) => i.scripts).flat(1).filter(Boolean).map(({ children: i, ...s }) => ({ tag: "script", attrs: { ...s, suppressHydrationWarning: true }, children: i })) }) }), a = [...r, ...t];
  return jsx(Fragment, { children: a.map((o, i) => createElement(ye, { ...o, key: `tsr-scripts-${o.tag}-${i}` })) });
}, At = `const __TSR_SSR__={matches:[],streamedValues:{},initMatch:o=>(__TSR_SSR__.matches.push(o),o.extracted?.forEach(l=>{if(l.type==="stream"){let r;l.value=new ReadableStream({start(e){r={enqueue:t=>{try{e.enqueue(t)}catch{}},close:()=>{try{e.close()}catch{}}}}}),l.value.controller=r}else{let r,e;l.value=new Promise((t,a)=>{e=a,r=t}),l.value.reject=e,l.value.resolve=r}}),!0),resolvePromise:({matchId:o,id:l,promiseState:r})=>{const e=__TSR_SSR__.matches.find(t=>t.id===o);if(e){const t=e.extracted?.[l];if(t&&t.type==="promise"&&t.value&&r.status==="success")return t.value.resolve(r.data),!0}return!1},injectChunk:({matchId:o,id:l,chunk:r})=>{const e=__TSR_SSR__.matches.find(t=>t.id===o);if(e){const t=e.extracted?.[l];if(t&&t.type==="stream"&&t.value?.controller)return t.value.controller.enqueue(new TextEncoder().encode(r.toString())),!0}return!1},closeStream:({matchId:o,id:l})=>{const r=__TSR_SSR__.matches.find(e=>e.id===o);if(r){const e=r.extracted?.[l];if(e&&e.type==="stream"&&e.value?.controller)return e.value.controller.close(),!0}return!1},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach(o=>{o.remove()})}};window.__TSR_SSR__=__TSR_SSR__;
`;
function Pt(e, t) {
  e.ssr = { manifest: t, serializer: y }, e.serverSsr = { injectedHtml: [], streamedKeys: /* @__PURE__ */ new Set(), injectHtml: (r) => {
    const a = Promise.resolve().then(r);
    return e.serverSsr.injectedHtml.push(a), e.emit({ type: "onInjectedHtml", promise: a }), a.then(() => {
    });
  }, injectScript: (r, a) => e.serverSsr.injectHtml(async () => `<script class='tsr-once'>${await r()}; if (typeof __TSR_SSR__ !== 'undefined') __TSR_SSR__.cleanScripts()<\/script>`), streamValue: (r, a) => {
    warning(!e.serverSsr.streamedKeys.has(r), "Key has already been streamed: " + r), e.serverSsr.streamedKeys.add(r), e.serverSsr.injectScript(() => `__TSR_SSR__.streamedValues['${r}'] = { value: ${I$1(e.ssr.serializer.stringify(a), { isScriptContext: true, wrap: true, json: true })}}`);
  }, onMatchSettled: Lt }, e.serverSsr.injectScript(() => At, { logScript: false });
}
function jt(e) {
  var t, r;
  const a = { manifest: e.ssr.manifest, dehydratedData: (r = (t = e.options).dehydrate) == null ? void 0 : r.call(t) };
  e.serverSsr.injectScript(() => `__TSR_SSR__.dehydrated = ${I$1(e.ssr.serializer.stringify(a), { isScriptContext: true, wrap: true, json: true })}`);
}
function Mt(e, t) {
  const r = [];
  return { replaced: Y(e, (o, i) => {
    if (o instanceof ReadableStream) {
      const [s, l] = o.tee(), c = { type: "stream", path: i, id: r.length, matchIndex: t.match.index, stream: l };
      return r.push(c), s;
    } else if (o instanceof Promise) {
      const s = defer$1(o), l = { type: "promise", path: i, id: r.length, matchIndex: t.match.index, promise: s };
      r.push(l);
    }
    return o;
  }), extracted: r };
...
function Lt(e) {
  ...
  if (r.loaderData !== void 0) {
    const c = Mt(r.loaderData, { match: r });
    r.loaderData = c.replaced, a = c.extracted, o = a.reduce((h, d) => X(h, ["temp", ...d.path], void 0), { temp: c.replaced }).temp;
  }
  const i = `__TSR_SSR__.initMatch(${I$1({ id: r.id, __beforeLoadContext: t.ssr.serializer.stringify(r.__beforeLoadContext), loaderData: t.ssr.serializer.stringify(o), error: t.ssr.serializer.stringify(r.error), extracted: a == null ? void 0 : a.map((c) => pick(c, ["type", "path"])), updatedAt: r.updatedAt, status: r.status }, { isScriptContext: true, wrap: true, json: true })})`;
  t.serverSsr.injectScript(() => i), a && a.forEach((c) => c.type === "promise" ? s(c) : l(c));
  function s(c) {
    t.serverSsr.injectScript(async () => (await c.promise, `__TSR_SSR__.resolvePromise(${I$1({ matchId: r.id, id: c.id, promiseState: c.promise[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`));
  }
  function l(c) {
    t.serverSsr.injectHtml(async () => {
      try {
        ...
        let d = null;
        for (; !(d = await h.read()).done; ) if (d.value) {
          const p = `__TSR_SSR__.injectChunk(${I$1({ matchId: r.id, id: c.id, chunk: d.value }, { isScriptContext: true, wrap: true, json: true })})`;
          t.serverSsr.injectScript(() => p);
        }
        t.serverSsr.injectScript(() => `__TSR_SSR__.closeStream(${I$1({ matchId: r.id, id: c.id }, { isScriptContext: true, wrap: true, json: true })})`);
      } catch (h) {
...
function X(e, t, r) {
  ...
  const [a, ...o] = t;
  return Array.isArray(e) ? e.map((i, s) => s === Number(a) ? X(i, o, r) : i) : isPlainObject$1(e) ? { ...e, [a]: X(e[a], o, r) } : e;
}
function Y(e, t, r = []) {
  if (isPlainArray(e)) return e.map((o, i) => Y(o, t, [...r, `${i}`]));
  if (isPlainObject$1(e)) {
    const o = {};
    for (const i in e) o[i] = Y(e[i], t, [...r, i]);
    return o;
  }
  const a = t(e, r);
  return a !== e ? a : e;
}
function Ot({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (a) => {
    const o = toWebRequest(a), i = new URL(o.url), s = i.href.replace(i.origin, ""), l = createMemoryHistory({ initialEntries: [s] }), c = e();
    Pt(c, t == null ? void 0 : t()), c.update({ history: l }), await c.load(), jt(c);
    const h = Bt({ event: a, router: c });
    return await r({ request: o, router: c, responseHeaders: h });
  });
}
function Bt(e) {
  e.event.__tsrHeadersSent = true;
  let t = W(getResponseHeaders(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((a) => a.headers));
  const { redirect: r } = e.router.state;
  return r && (t = W(t, r.headers, { Location: r.href })), t;
}
function Dt(e, t) {
  return we(e, t);
}
function Ft(e, t) {
  return Readable$1.fromWeb(we(e, Readable$1.toWeb(t)));
}
const Wt = /(<body)/, Ut = /(<\/body>)/, Jt = /(<\/html>)/, Gt = /(<head.*?>)/, qt = /(<\/[a-zA-Z][\w:.-]*?>)/g, Vt = new TextDecoder();
function Zt() {
  let e;
  const t = new TextEncoder(), a = { stream: new ReadableStream$1({ start(o) {
    e = o;
  } }), write: (o) => {
    e.enqueue(t.encode(o));
  }, end: (o) => {
    o && e.enqueue(t.encode(o)), e.close(), a.destroyed = true;
  }, destroy: (o) => {
    e.error(o);
  }, destroyed: false };
  return a;
...
async function Kt(e, t) {
  ...
  try {
    const i = e.getReader();
    let s;
    for (; !(s = await i.read()).done; ) (r = t.onData) == null || r.call(t, s);
    (a = t.onEnd) == null || a.call(t);
  } catch (i) {
    (o = t.onError) == null || o.call(t, i);
  }
}
function we(e, t) {
  const r = Zt();
  let a = true, o = "", i = "", s = false, l = false, c = "", h = "";
  function d() {
    const m = o;
    return o = "", m;
  }
  function p(m) {
    return m instanceof Uint8Array ? Vt.decode(m) : String(m);
  }
  ...
  const He = e.subscribe("onInjectedHtml", (m) => {
    ne(m.promise);
  });
  function ne(m) {
    P++, m.then((j) => {
  ...
  return b.then(() => {
    ...
    const j = p(m.value);
    let g = c + j;
    const G = g.match(Ut), ae = g.match(Jt);
    if (s || g.match(Wt) && (s = true), !l) {
      const w = g.match(Gt);
      if (w) {
        l = true;
        const oe = w.index, ie = w[0], Ae = g.slice(oe + ie.length);
        r.write(g.slice(0, oe) + ie + d()), g = Ae;
      }
    }
    if (!s) {
      r.write(g), c = "";
    ...
    if (G && ae && G.index < ae.index) {
      const w = G.index;
      i = g.slice(w), r.write(g.slice(0, w) + d()), c = "";
      return;
    }
    let q, M = 0;
    for (; (q = qt.exec(g)) !== null; ) M = q.index + q[0].length;
    if (M > 0) {
      const w = g.slice(0, M) + d() + h;
      r.write(w), c = g.slice(M);
    } else c = g, h += d();
  }, onEnd: () => {
    a = false, P === 0 && b.resolve();
  }, onError: (m) => {
    console.error("Error reading appStream:", m), r.destroy(m);
  } }), r.stream;
}
const Xt = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof L$1.renderToReadableStream == "function") {
    const a = await L$1.renderToReadableStream(jsx(de, { router: t }), { signal: e.signal });
  ...
  if (typeof L$1.renderToPipeableStream == "function") {
    ...
    try {
      const i = L$1.renderToPipeableStream(jsx(de, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        i.pipe(a);
      } } : { onShellReady() {
        i.pipe(a);
      } }, onError: (s, l) => {
        console.error("Error in renderToPipeableStream:", s, l);
      } });
    } catch (i) {
...
const xe = Symbol("$HTTPEvent");
function Qt(e) {
  return typeof e == "object" && (e instanceof H3Event || (e == null ? void 0 : e[xe]) instanceof H3Event || (e == null ? void 0 : e.__is_event__) === true);
}
function er(e) {
  return function(...t) {
    var r;
    let a = t[0];
    if (Qt(a)) t[0] = a instanceof H3Event || a.__is_event__ ? a : a[xe];
    else {
      if (!((r = globalThis.app.config.server.experimental) != null && r.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (a = Yt(), !a) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      t.unshift(a);
    }
    return e(...t);
  };
}
const tr = er(getHeaders);
function rr() {
  var e;
  return getContext("nitro-app", { asyncContext: !!((e = globalThis.app.config.server.experimental) != null && e.asyncContext), AsyncLocalStorage: AsyncLocalStorage });
}
...
const ar = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/_authed"], preloads: ["/_build/assets/client-zLRlkAJC.js", "/_build/assets/client-m4m4Z0YJ.js"] }, "/": { filePath: "index.tsx" }, "/_authed": { filePath: "_authed.tsx", children: ["/_authed/climbs/$climbId", "/_authed/locations/$locationId", "/_authed/profile/$", "/_authed/seshes/$seshId", "/_authed/climbs/", "/_authed/locations/", "/_authed/seshes/"] }, "/_authed/climbs/$climbId": { filePath: "_authed/climbs/$climbId.tsx", parent: "/_authed" }, "/_authed/locations/$locationId": { filePath: "_authed/locations/$locationId.tsx", parent: "/_authed" }, "/_authed/profile/$": { filePath: "_authed/profile.$.tsx", parent: "/_authed" }, "/_authed/seshes/$seshId": { filePath: "_authed/seshes/$seshId.tsx", parent: "/_authed" }, "/_authed/climbs/": { filePath: "_authed/climbs/index.tsx", parent: "/_authed" }, "/_authed/locations/": { filePath: "_authed/locations/index.tsx", parent: "/_authed" }, "/_authed/seshes/": { filePath: "_authed/seshes/index.tsx", parent: "/_authed" } } });
function or(e) {
  return globalThis.MANIFEST[e];
}
function ir() {
  var _a;
  const e = ar(), t = e.routes.__root__ = e.routes.__root__ || {};
  t.assets = t.assets || [];
  const r = or("client");
...
function sr() {
  ...
  return { ...e, routes: Object.fromEntries(Object.entries(e.routes).map(([t, r]) => {
    const { preloads: a, assets: o } = r;
    return [t, { preloads: a, assets: o }];
  })) };
}
async function cr(e, t, r) {
  ...
  if (isPlainObject$1(o) && o.method) {
    const l = o, c = l.data instanceof FormData ? "formData" : "payload", h = new Headers({ ...c === "payload" ? { "content-type": "application/json", accept: "application/json" } : {}, ...l.headers instanceof Headers ? Object.fromEntries(l.headers.entries()) : l.headers });
    if (l.method === "GET") {
      const b = encode$1({ payload: y.stringify({ data: l.data, context: l.context }) });
      b && (e.includes("?") ? e += `&${b}` : e += `?${b}`);
    }
    const d = await r(e, { method: l.method, headers: h, ...lr(l) }), p = await fe(d);
    if ((a = p.headers.get("content-type")) != null && a.includes("application/json")) {
      const b = y.decode(await p.json());
      if (isRedirect$1(b) || isNotFound(b) || b instanceof Error) throw b;
      return b;
    }
    return p;
  }
  const i = await fe(await r(e, { method: "POST", headers: { Accept: "application/json", "Content-Type": "application/json" }, body: JSON.stringify(t) })), s = i.headers.get("content-type");
  return s && s.includes("application/json") ? y.decode(await i.json()) : i.text();
}
function lr(e) {
  var _a;
...
async function fe(e) {
  if (!e.ok) {
    ...
    throw t && t.includes("application/json") ? y.decode(await e.json()) : new Error(await e.text());
  }
  return e;
}
function dr(e) {
...
const ur = (e, t) => {
  const r = `/${dr(t)}/${e}`;
  return Object.assign((...o) => cr(r, o, async (i, s) => (s.headers = W(tr(), s.headers), $fetch.native(i, s))), { url: r, functionId: e });
};
function Se({ error: e }) {
  const t = useRouter(), r = useMatch({ strict: false, select: (a) => a.id === rootRouteId });
...
const Er = createFileRoute("/_authed")({ beforeLoad: ({ context: e }) => {
  ...
  throw e;
} }), Hr = () => import('../build/index-DO81Sifg.mjs'), ke = createFileRoute("/")({ component: lazyRouteComponent(Hr, "component", () => ke.ssr) }), Ar = () => import('../build/index-CBPJuYSz.mjs'), Pr = () => import('../build/index-CBPJuYSz.mjs'), Re = createFileRoute("/_authed/seshes/")({ loader: lazyFn(Pr, "loader"), component: lazyRouteComponent(Ar, "component", () => Re.ssr) }), jr = () => import('../build/index-DQ5uKE0Y.mjs'), Mr = () => import('../build/index-DQ5uKE0Y.mjs'), Ce = createFileRoute("/_authed/locations/")({ loader: lazyFn(Mr, "loader"), component: lazyRouteComponent(jr, "component", () => Ce.ssr) }), Lr = () => import('../build/index-BeldkAS-.mjs'), Or = () => import('../build/index-BeldkAS-.mjs'), $e = createFileRoute("/_authed/climbs/")({ loader: lazyFn(Or, "loader"), component: lazyRouteComponent(Lr, "component", () => $e.ssr) }), Br = () => import('../build/_seshId-4aVW5buw.mjs'), Dr = () => import('../build/_seshId-4aVW5buw.mjs'), Ie = createFileRoute("/_authed/seshes/$seshId")({ loader: lazyFn(Dr, "loader"), errorComponent: Fr, component: lazyRouteComponent(Br, "component", () => Ie.ssr), notFoundComponent: () => jsx(H, { children: "Sesh not found" }) });
function Fr({ error: e }) {
  return jsx(ErrorComponent, { error: e });
}
const Wr = () => import('../build/profile._-CqEadVfS.mjs'), Ur = () => import('../build/profile._-CqEadVfS.mjs'), Te = createFileRoute("/_authed/profile/$")({ loader: lazyFn(Ur, "loader"), component: lazyRouteComponent(Wr, "component", () => Te.ssr) }), Jr = () => import('../build/_locationId-CxiU5eSb.mjs'), Gr = () => import('../build/_locationId-CxiU5eSb.mjs'), Ne = createFileRoute("/_authed/locations/$locationId")({ loader: lazyFn(Gr, "loader"), errorComponent: qr, component: lazyRouteComponent(Jr, "component", () => Ne.ssr), notFoundComponent: () => jsx(H, { children: "Location not found" }) });
function qr({ error: e }) {
  return jsx(ErrorComponent, { error: e });
}
const Vr = () => import('../build/_climbId-BfcgRlJO.mjs'), Zr = () => import('../build/_climbId-BfcgRlJO.mjs'), Ee = createFileRoute("/_authed/climbs/$climbId")({ loader: lazyFn(Zr, "loader"), errorComponent: Kr, component: lazyRouteComponent(Vr, "component", () => Ee.ssr), notFoundComponent: () => jsx(H, { children: "Climb not found" }) });
function Kr({ error: e }) {
  return jsx(ErrorComponent, { error: e });
}
const z = Er.update({ id: "/_authed", getParentRoute: () => re }), Xr = ke.update({ id: "/", path: "/", getParentRoute: () => re }), Yr = Re.update({ id: "/seshes/", path: "/seshes/", getParentRoute: () => z }), Qr = Ce.update({ id: "/locations/", path: "/locations/", getParentRoute: () => z }), en = $e.update({ id: "/climbs/", path: "/climbs/", getParentRoute: () => z }), tn = Ie.update({ id: "/seshes/$seshId", path: "/seshes/$seshId", getParentRoute: () => z }), rn = Te.update({ id: "/profile/$", path: "/profile/$", getParentRoute: () => z }), nn = Ne.update({ id: "/locations/$locationId", path: "/locations/$locationId", getParentRoute: () => z }), an = Ee.update({ id: "/climbs/$climbId", path: "/climbs/$climbId", getParentRoute: () => z }), on = { AuthedClimbsClimbIdRoute: an, AuthedLocationsLocationIdRoute: nn, AuthedProfileSplatRoute: rn, AuthedSeshesSeshIdRoute: tn, AuthedClimbsIndexRoute: en, AuthedLocationsIndexRoute: Qr, AuthedSeshesIndexRoute: Yr }, sn = z._addFileChildren(on), cn = { IndexRoute: Xr, AuthedRoute: sn }, ln = re._addFileChildren(cn)._addFileTypes();
function dn() {
  return createRouter$2({ routeTree: ln, defaultPreload: "intent", defaultErrorComponent: Se, defaultNotFoundComponent: () => jsx(H, {}), scrollRestoration: true });
}
const un = Ot({ createRouter: dn, getRouterManifest: sr }), hn = createClerkHandler(un), Nn = hn(Xt);

const handlers = [
  { route: '/_server', handler: ne, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: Nn, lazy: false, middleware: true, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/jack/dev/cl-frontend/.data/kv"}));
...
export { $e as $, A, Ce as C, D, Ee as E, Ie as I, K, Ne as N, Re as R, S, Te as T, fr as a, f, handler as h, mr as m, node$1 as n, pr as p, re$1 as r, ur as u, vr as v };
